...
const addDivision = {
    body: Joi.object().keys({
        ...
        messages({
            ...
            'string.min': 'Division code must be at least 1 character',
        ...
        optionalCourseIds: Joi.array().items(uuid.messages({
            'string.guid': 'Each optional course ID must be a valid UUID'
        })).
        messages({
            'array.base': 'Optional course IDs must be an array'
        })
    })
};
