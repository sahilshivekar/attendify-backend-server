...
module.exports = {
    async up(queryInterface, Sequelize) {
        ...
        const divisionsToInsert = [
            ...
            {
                division_code: 'A',
                semester_id: getSemesterId(compBranchId, 7)
            },
            {
                division_code: 'B',
                semester_id: getSemesterId(compBranchId, 7)
            ...
            {
                division_code: 'A',
                semester_id: getSemesterId(compBranchId, 5)
            },
            {
                division_code: 'B',
                semester_id: getSemesterId(compBranchId, 5)
            ...
            {
                division_code: 'A',
                semester_id: getSemesterId(compBranchId, 3)
            },
            {
                division_code: 'B',
                semester_id: getSemesterId(compBranchId, 3)
            ...
            {
                division_code: 'A',
                semester_id: getSemesterId(compBranchId, 1)
            },
            {
                division_code: 'B',
                semester_id: getSemesterId(compBranchId, 1)
            ...
            {
                division_code: 'A',
                semester_id: getSemesterId(civilBranchId, 1)
            },
            {
                division_code: 'B',
                semester_id: getSemesterId(civilBranchId, 1)
